Image /page/0/Picture/0 description: A minimalist, brush-stroke style icon featuring a stylized mountain peak positioned centrally. Behind the mountain, an arc represents a sun with radiating rays. Below the mountain, two curved lines suggest water or waves.

Image /page/0/Picture/1 description: The image features a black and white graphic consisting of a stylized circular logo at the top, positioned above three lines of text. The logo resembles a leaf or a stylized wave form. Below the logo, the text reads: 'Matthew Rodriquez' on the first line, followed by 'Secretary for' on the second line, and 'Environmental Protection' on the third line.

# Department of Toxic Substances Control

Image /page/0/Picture/3 description: The image features the Great Seal of the State of California at the top. Below the seal, the text reads 'Edmund G. Brown Jr.' on the first line and 'Governor' on the second line.
