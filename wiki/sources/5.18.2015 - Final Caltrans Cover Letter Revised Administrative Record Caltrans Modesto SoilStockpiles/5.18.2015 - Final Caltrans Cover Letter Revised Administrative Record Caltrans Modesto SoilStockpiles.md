Image /page/0/Picture/0 description: The image features a minimalist black-and-white graphic logo consisting of two curved, solid black shapes resembling crescents or teardrop segments arranged to suggest a circular form, with a single thin diagonal line extending from the upper left, pointing towards the center.

### Department of Toxic Substances Control

Image /page/0/Picture/4 description: The image features the Great Seal of the State of California, a circular emblem depicting a landscape with a river, mountains, a ship, and a figure of the goddess Minerva, along with a California grizzly bear in the foreground, with the word 'EUREKA' above the landscape. The text 'THE GREAT SEAL OF THE STATE OF CALIFORNIA' encircles the image. Partially visible below the seal is text that appears to read 'Edmund G. Brown'.
...
Image /page/3/Picture/0 description: A simple black-and-white icon featuring a stylized mountain peak, a rising or setting sun with radiating lines above it, and two wavy horizontal lines below the mountain.

Image /page/3/Picture/1 description: A black and white logo consisting of a stylized graphic element at the top, which resembles a circular shape partially obscured by a dark, curved form or shadow, positioned above the partially visible text 'Matthews... P...'

### Department of Toxic Substances Control

Image /page/3/Picture/4 description: The image features the official Great Seal of the State of California at the top, which portrays the goddess Minerva, a grizzly bear, and a landscape scene with ships and mountains, encircled by the text 'THE GREAT SEAL OF THE STATE OF CALIFORNIA' and the motto 'EUREKA'. Below the seal, the text 'Edmund G. Brown Jr.' is centered, followed by the word 'Governor' on the next line.
...
Image /page/8/Picture/0 description: A minimalist, hand-drawn black and white sketch featuring a stylized sun rising behind a mountain peak, with wavy lines representing water or a horizon below the mountain.

Image /page/8/Picture/1 description: A black and white abstract logo depicting a crescent moon shape extending downwards, with a diagonal line piercing through it from the upper left side, partially obscured by a larger black blob-like shape in the upper right quadrant.

### Department of Toxic Substances Control

Image /page/8/Picture/4 description: A black and white image displaying The Great Seal of the State of California at the top, followed by the text 'Edmund G. Brown' partially visible at the bottom.
...
Image /page/12/Picture/0 description: A simple, hand-drawn black and white icon depicting a sun rising or setting over a mountain range and stylized water waves. The sun, represented by a circular arc with short radiating lines, is positioned behind the jagged peak of a mountain. Below the mountain, two curved lines represent ripples or waves on water.

Image /page/12/Picture/1 description: The image features a minimalist black-and-white graphic composed of an abstract icon above the text 'Matthew Rodriguez'. The icon consists of a bold, crescent-like curve that partially cradles an oval shape, bisected by a single straight line slanting downwards from left to right. The font used for the name is a bold, serif typeface.

### Department of Toxic Substances Control

Image /page/12/Picture/4 description: A black and white circular emblem representing the Great Seal of the State of California. The outer border contains the text 'THE GREAT SEAL OF THE STATE OF' at the top and 'CALIFORNIA' at the bottom. The interior depicts the Roman goddess Minerva seated, holding a spear, with a grizzly bear standing in the foreground, and a landscape featuring a bay, mountains, and a sailing ship in the background. The word 'EUREKA' is positioned at the top of the scene.
