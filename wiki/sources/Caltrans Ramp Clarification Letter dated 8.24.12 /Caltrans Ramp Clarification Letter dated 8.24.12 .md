...
Image /page/0/Picture/4 description: A circular logo or seal, largely in high-contrast black and white, featuring a stylized landscape inside. The central imagery appears to include hills or mountains beneath a sky with a central pointed element, possibly a spear or monument, reaching toward the top circular border. The border contains text, though it is heavily degraded and not fully legible.
