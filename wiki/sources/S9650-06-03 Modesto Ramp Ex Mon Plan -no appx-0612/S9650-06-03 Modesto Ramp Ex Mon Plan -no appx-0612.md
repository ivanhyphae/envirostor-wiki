Image /page/0/Picture/0 description: An aerial photograph showing a section of a highway next to an empty lot, labeled 'STOCKPILE 3 EXCAVATION MONITORING PLAN MODESTO RAMP REHABILITATION PROJECT' in the top center and 'State Route 99 Kansas Avenue Northbound Off-Ramp Modesto, California' at the bottom. The image captures a landscape view with green grassy areas, a multi-lane roadway with traffic, and adjacent industrial or commercial building structures.

###### *PREPARED FOR:*

CALIFORNIA DEPARTMENT OF TRANSPORTATION – DISTRICT 6 855 M STREET, SUITE 200 FRESNO, CALIFORNIA 93721

Image /page/0/Picture/3 description: The image features the California Department of Transportation (Caltrans) logo. At the top, there is a stylized, bold, italicized 'Ct' emblem where the 'C' is teal and the 't' is blue. Below this, the word 'Caltrans' is written in a black, heavy, slanted sans-serif font. Both the 'Ct' symbol and the word 'Caltrans' have a small registered trademark symbol (R) next to them.

###### *PREPARED BY:*

GEOCON CONSULTANTS, INC. 3160 GOLD VALLEY DRIVE, SUITE 800 RANCHO CORDOVA, CALIFORNIA 95742

Image /page/0/Picture/6 description: The logo for GEOCON, featuring a stylized icon composed of interconnected, multi-colored geometric shapes forming a diamond-like pattern above the word GEOCON written in a serif, dark green font.

GEOCON PROJECT NO. S9650-06-03 CONTRACT NO. 06A1634, EA 10-0A671 JUNE 2012

# JUNE 2012

Image /page/1/Picture/0 description: The image shows the company logo for 'GEOCON CONSULTANTS, INC.' The word 'GEOCON' is prominently displayed in a large, teal-colored serif font with a 3D beveled effect. Directly below it, the words 'CONSULTANTS, INC.' appear in a smaller, standard black sans-serif font.

## GEOTECHNICAL • ENVIRONMENTAL • MATERIALS

Image /page/1/Picture/2 description: A stylized abstract logo shaped like a diamond or square rotated at a 45-degree angle. It consists of interlocking geometric bands in shades of teal, black, and light gray/white, with a prominent solid blue triangle positioned in the center, appearing to be set within a nook created by the overlapping bands.
...
The calculated Fence Line Action Level for total dust above (upwind) background levels is 8 mg/m<sup>3</sup>. Since this level is close to the Cal/OSHA 8-hour time-weighted average (8-Hr TWA) PEL of 10 mg/m<sup>3</sup> for total particulates, and assuming a safety factor 0.5, a downwind "Total Dust Trigger" concentration of 4 mg/m<sup>3</sup> above up-wind background dust levels will be used for ambient real-time air monitoring.

### **4.3.2 Perimeter Air Monitoring Plan**

Using the maximum total lead concentration of approximately 190 mg/kg reported in the analytical testing for soil samples collected on April 16, 2012, the calculated "trigger" Fence Line Action Level for a total airborne dust concentration above background (upwind) levels measured at the downwind perimeters of the excavation site(s) is 4 mg/m3 ; as noted above the calculated Total Dust Trigger concentration includes a safety factor of 0.5.
...
The pre-weighed 5µ PVC filters collected on the first day of monitoring will be submitted to the laboratory for analysis of inorganic lead and barium under 24-hour turnaround time. Assuming reported levels of inorganic lead are below the ARB-OEHHA unit risk for lead of 0.0015 mg/m3 (1.5 µg/m3 ), and the Fence Line Action Level of 4 mg/m3 for a total airborne dust concentrations above background are not exceeded, all other filter samples will be held until the Stockpile 3 excavation operations are completed and then submitted to the laboratory for routine analytical turnaround time of from 5 to 7 business days.
...
Image /page/14/Figure/0 description: This is a Figure 1 Vicinity Map titled 'Modesto Ramp Rehabilitation Project' by Geocon Consultants, Inc., dated June 2012, located in Stanislaus County, California. The map depicts Modesto and the surrounding area, with Highway 99 running diagonally through the center. Key features include the 'Project Site' highlighted near the crossing of Highway 99 and Needham St/Elm Ave, labeled 'FMC Boundary' and 'Former Disposal Ponds' nearby. Three numbered 'Stockpile' areas are indicated in yellow along the highway. Identified landmarks include Modesto Junior College (West and East campuses), Doctors Hospital, and the Muni Golf Course near the Tuolumne River. The map provides a scale of 0 to 1/2 miles and includes a north directional arrow.

Image /page/15/Figure/0 description: The image is an improvement plan for the Kansas Ave NB off-ramp, part of the Modesto Ramp Rehabilitation Project in Stanislaus County, California, dated June 2012 by Geocon Consultants, Inc. The engineering drawing (Figure 2) illustrates the roadway alignment and construction zones for Route 99 and the Kansas Avenue off-ramp. Key features include a 'Stockpile #3' area marked as an 'Approximate Extent of Proposed Stockpile 3 Construction Excavation,' a 'Barium Pile,' and various callouts indicating construction points such as 'Beg MBGR,' 'Beg HMA DIKE (TYPE E),' 'End Conc CURB,' and 'Beg RETAINING WALL.' There are several reference lines labeled 'A' Line, 'G' Line, and 'L' Line, with specific stationing marks like 'G 67+00.00' and 'G 77+66.90.' The drawing includes a north arrow, a scale bar (0 to 100 feet), and detailed professional contact information for the firm based in Rancho Cordova, CA.

Image /page/16/Figure/0 description: A site plan for the Modesto Ramp Rehabilitation Project in Stanislaus County, California, dated June 2012 by Geocon Consultants, Inc. The image is an aerial view showing a grassy area next to a highway, labeled 'STOCKPILE 3'. Key markings include a 'Proposed Stockpile 3 Excavation Area', locations for monitoring wells (MW6, MW7, MW8), air monitoring station locations represented by red circular icons, and an 'Approximate Fence Location'. The area also features a 'K-Rail Storage Area', a gate, and is situated near 'MID Lateral #4'. A north arrow is provided in the top right corner, and a legend explains the various site markers.