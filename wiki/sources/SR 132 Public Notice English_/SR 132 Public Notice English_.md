Image /page/0/Picture/0 description: The image features the black and white logo for Caltrans, consisting of a stylized, bold, interconnected 'Ct' letterform centered within a white, rounded-square frame with thick black borders on the left and right sides. Below the 'Ct' symbol, the word 'Caltrans' is written in a stylized, bold, sans-serif font.

# **PUBLIC NOTICE**

Image /page/0/Picture/2 description: The image features a logo for the California Department of Toxic Substances Control. The logo is enclosed in a rounded rectangle and consists of a line-art graphic depicting a sun radiating above a mountain range, which is positioned above stylized water waves. Below this graphic, the text 'California Department of Toxic Substances Control' is written in a clear, serif font.
...
Image /page/0/Figure/13 description: A simplified map highlighting project locations in Stanislaus County, specifically focusing on the area around Modesto. The map labels major roads including Highway 99, Highway 108, and Highway 132, as well as local streets like Kansas Ave, Maze Blvd, Paradise Rd, and various numbered streets. Two specific areas are marked as 'PROJECT LOCATION', one near the intersection of Highway 132/Maze Blvd and Dakota Ave, and another near where Highway 99 crosses near College Rd. A north directional arrow is provided, and the map is marked as 'NOT TO SCALE'.
