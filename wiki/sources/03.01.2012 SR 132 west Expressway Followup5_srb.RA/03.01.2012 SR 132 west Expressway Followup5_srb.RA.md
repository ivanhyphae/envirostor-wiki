Image /page/0/Picture/0 description: A line art graphic composed of thick, sketched black strokes. It depicts a stylized sun rising or setting behind a geometric, triangular mountain shape, with wavy horizontal lines representing water or terrain situated below the mountain.

Image /page/0/Picture/1 description: The image features a logo represented by a black circle with a thin, slanted diagonal line slicing through it. Below the logo is the text 'Matthew Rodriquez' on the first line, followed by 'Secretary for' on the second line, and 'Environmental Protection' on the third line, all in a black serif font.

# Department of Toxic Substances Control

Image /page/0/Picture/3 description: The image features the Great Seal of the State of California at the top, which is a circular emblem containing a drawing that includes a bear, a figure of Minerva, mountains, and a river. Beneath the seal, the name 'Edmund G. Brown Jr.' is printed on the first line, followed by the title 'Governor' centered below it.
