Image /page/0/Picture/0 description: The image features the company name 'GEOCON' written in a large, serif, green-toned font with a 3D beveled effect, positioned above the text 'CONSULTANTS, INC.' in a smaller, plain, black serif font.

Image /page/0/Picture/1 description: The image features the capitalized text 'GEOTECHNICAL ENVIRONMENTAL' written in a clean, sans-serif font, with a small, solid teal square inserted as a separator between 'GEOTECHNICAL' and 'ENVIRONMENTAL'.

Image /page/0/Picture/2 description: A square-shaped geometric logo featuring a central blue triangle pointing downwards. The logo consists of four interlocked, thick, stylized L-shaped bars forming a diamond-like outline. The bars alternate in color, featuring two teal-colored segments opposite each other, one black segment, and one light gray segment, all featuring beveled edges to create a 3D effect.
...
Image /page/4/Figure/0 description: This is a vicinity map titled 'Caltrans Modesto Soil Stockpiles' depicting an area in Stanislaus County, California, dated February 2013 and labeled as Figure 1. The map illustrates the location of a 'PROJECT SITE' near Highway 99 in Modesto, specifically situated near the intersection of various roads including Emerald Ave and Elm Ave. The document includes the branding for GEOCON CONSULTANTS, INC., providing their contact information, the project number S9525-06-44A, and the task order number 44. The visual includes landmarks such as the Modesto Junior College (West and East campuses), the Tuolumne River, and the Muni Golf Course, with a scale bar indicating a half-mile distance.

Image /page/5/Picture/0 description: This is an overhead map showing a section of industrial and residential area with Highway 99 running diagonally through the center. The map marks three distinct excavation or staging areas designated as "STOCKPILE 1," "STOCKPILE 2," and "STOCKPILE 3." Stockpile 1 is located on the western side of the map near the intersection of Emerald Avenue. Stockpile 2 is a large rectangular area just south of Kansas Avenue. Stockpile 3 is an elongated area running alongside Highway 99 on the eastern side. The map also labels the "Former Disposal Pond" in two sections and a "Former FMC Facility" situated to the north of Highway 99. Other streets labeled on the map include Kansas Avenue, Loletta Avenue, and Emerald Avenue. Text at the bottom right corner indicates the document is prepared by Geocon.
...
Image /page/5/Picture/5 description: A north arrow icon consisting of a black triangle pointing upwards inside a black circle, with the capital letter 'N' positioned below the triangle inside the circle.
