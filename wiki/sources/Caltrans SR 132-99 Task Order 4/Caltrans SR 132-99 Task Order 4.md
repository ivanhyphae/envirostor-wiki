...
Image /page/17/Figure/1 description: This is a document titled 'Project Vicinity Map' for the Caltrans Modesto Soil Stockpiles in Stanislaus County. The figure features a map of California with county boundaries, including a call-out box that displays a more detailed street-level map of the Modesto area. This zoomed-in area features major roads including Highway 99 and Highway 132, as well as landmarks like the Modesto Junior College. The Caltrans logo is located in the bottom left, and a compass rose indicating North is in the bottom right.

# ATTACHMENT B

Image /page/18/Picture/1 description: This is an aerial satellite view of an urban area, featuring a long, dark canal running horizontally across the frame. Three specific sections alongside the canal are highlighted and labeled as 'SP-1', 'SP-2', and 'SP-3'. The image includes a highway marked 'SR 99' traversing from the upper center to the lower right, and a north-pointing arrow labeled 'N' in the bottom left corner. A street labeled 'EMERALD AVE' runs vertically, crossing the canal. Labels for 'KANSAS' are visible in the upper section of the image.
...
[Table /page/19/Table/4]

# ATTACHMENT C

Cost Estimate
DTSC Oversight Modesto Soil Stockpiles- SR 13
