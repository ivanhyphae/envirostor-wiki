...
Image /page/13/Figure/1 description: A 'Project Vicinity Map' titled 'Caltrans Modesto Soil Stockpiles, Stanislaus County'. It features a large outline map of California highlighting Stanislaus County, and an inset rectangular map providing a detailed street-level vicinity view of the site, including references to the Modesto Junior College area. There is a Caltrans logotype in the lower-left corner and a north arrow indicating the orientation.

# ATTACHMENT

Image /page/14/Picture/1 description: This is an aerial photograph of an urban area showing three designated sites labeled 'SP-1', 'SP-2', and 'SP-3'. The sites are long, rectangular plots of land, separated by a north-south road labeled 'Emerald Ave'. To the east of SP-2 and SP-3 lies a major highway labeled 'SR 99'. The map includes a north-pointing arrow labeled 'N' and a caption in the bottom right corner reading 'Approximate Locations - Not to Scale'.
...
[Table /page/15/Table/3]

[Table /page/15/Table/4]
