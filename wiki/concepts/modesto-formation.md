...
### Definition
The Modesto Formation is a Quaternary alluvial geologic unit widely distributed in the San Joaquin Valley, California, particularly in and around the city of Modesto. It consists primarily of unconsolidated to poorly consolidated gravel, sand, silt, and clay deposited during the Pleistocene epoch as a series of coalescing alluvial fans and floodplain deposits derived from the Sierra Nevada. The formation is a major regional aquifer, providing groundwater for municipal, agricultural, and industrial uses.
...
- **Vulnerability to contamination**: The unconfined nature of the upper Modesto Formation means it is susceptible to surface-derived contaminants (e.g., from stockpiles, agriculture, or urban runoff). The presence of clay interbeds can provide some protection but also creates perched conditions.
- **Subsidence hazard**: Over-pumping of the formation, especially the fine-grained layers, can lead to land subsidence due to aquifer compaction.
- **Distinction from overlying Holocene deposits**: In many locations the Modesto Formation cannot be easily separated from younger alluvium by lithology alone; age dating (e.g., radiocarbon, stratigraphic position) is often required.
- **Water quality issues**: Naturally occurring arsenic, manganese, and occasionally high salinity can be present in deeper sections of the formation, requiring treatment.
...
- Quaternary Geology of the Central Valley