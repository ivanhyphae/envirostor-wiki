...
*   **Barium:**
    *   Maximum site-specific background: {{quote: "Maximum site-specific background 120 mg/kg"}}
    *   RDIP BCS removal threshold (groundwater protection): {{quote: "RDIP BCS removal threshold 1,000 mg/kg (groundwater protection)"}}
    *   Construction worker ESL: {{quote: "Construction worker ESL 3,000 mg/kg"}}
    *   Residential ESL: {{quote: "Residential ESL 15,000 mg/kg"}}
    *   Commercial ESL: {{quote: "Commercial ESL 220,000 mg/kg"}}
*   **Lead:**
