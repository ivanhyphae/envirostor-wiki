...
confidence: medium
created_at: 2026-08-11T02:51:17Z
---

# MW-5

## Overview
MW-5 is a groundwater monitoring well located at the Caltrans Modesto Soil Stockpiles site in Stanislaus County, California. It is part of the initial network of monitoring wells installed in 2006. This well has consistently reported concentrations of nitrate as nitrogen and total dissolved solids (TDS) that exceed applicable water quality thresholds.

## Site record
During the [[september-2013-sampling-event]], the depth to groundwater at MW-5 was measured at 42.05 feet below the top of casing (TOC). {{quote: "In September 2013, nitrate as nitrogen was reported at a concentration of 36 mg/l in the sample from MW-5, exceeding the primary Maximum Contaminant Level (MCL) of 10 mg/l."}} {{quote: "This was the highest nitrate concentration reported among the ten monitoring wells during that sampling event."}} {{quote: "Total dissolved solids (TDS) were reported at a concentration of 750 mg/l in MW-5, exceeding the secondary MCL of 500 mg/l."}} {{quote: "This was also the highest TDS concentration among the ten wells in September 2013."}} {{quote: "Sulfide was reported at a concentration of 0.012 mg/l in the MW-5 sample collected in September 2013, as documented in the laboratory report (Lab ID: 1302710-02)."}}

The dissolved metals analytical results for MW-5 from September 2013 did not show any concentrations exceeding their respective numeric water quality threshold values. {{quote: "On the Stiff diagrams for the September 2013 event, MW-5 was classified as sodium-dominant. This classification differed from historical sampling events, where MW-5 was described as consistently calcium-dominant."}} {{quote: "The September 2013 report suggests this shift 'may be indicative of a mixing of different water types at this location.'"}}

In the june-2014-sampling-event, the depth to groundwater at MW-5 was measured at 42.86 feet below TOC. {{quote: "In June 2014, nitrate as nitrogen was reported at 29 mg/l in MW-5, exceeding the primary MCL of 10 mg/l."}} {{quote: "TDS was reported at 680 mg/l in MW-5, exceeding the secondary MCL of 500 mg/l."}} {{quote: "The Stiff diagram for MW-5 in June 2014 indicated a sodium-dominant composition."}}

A review of nine recent groundwater sampling events (March, May, June, July, September, and November 2012; January, March, and June 2013) indicated that MW-5 has historically reported nitrate and TDS concentrations exceeding water quality thresholds. {{quote: "Nitrate as nitrogen concentrations have exceeded the primary MCL of 10 mg/l in MW-5 across multiple events, and TDS concentrations have exceeded the secondary MCL of 500 mg/l over the same period."}}

## Regulatory status
The September 2013 monitoring results for MW-5 were evaluated against the following water quality threshold values:
*   **Primary MCLs** (California Department of Public Health): Nitrate as nitrogen (10 mg/l) was exceeded. {{quote: "The reported nitrate concentrations for samples from MW-1, MW-4, MW-5, MW-6, and MW-10 equal or exceed the primary MCL for nitrate of 10 mg/l"}}
*   **Secondary MCLs** (California Department of Public Health): TDS (500 mg/l) was exceeded. {{quote: "and the reported TDS concentrations for samples from MW-1, MW-4, MW-5, MW-6 and MW-10 exceed the secondary MCL for TDS of 500 mg/l."}}

No exceedances of dissolved metals thresholds were reported for MW-5. {{quote: "The dissolved metals analytical results for MW-5 from September 2013, analyzed via EPA Method 6020 (ICP-MS) and EPA Method 7470A, did not show any concentrations exceeding their respective numeric water quality threshold values."}}

MW-5 was among the wells (along with MW-1, MW-4, MW-6, and MW-10) where both the primary MCL for nitrate and the secondary MCL for TDS were exceeded in September 2013.

## Open items
The shift in MW-5's ionic composition from calcium-dominant to sodium-dominant in 2013 was flagged for continued monitoring in the September 2013 report, as it may indicate mixing of different water types at this location. {{quote: "MW-5 was reported as sodium-dominant during this monitoring event but was consistently calcium-dominant during previous sampling events. This may be indicative of a mixing of different water types at this location."}} The September 2013 report does not document any formal regulatory action, enforcement, or remedial decision specifically tied to MW-5's exceedances. Groundwater monitoring was scheduled to continue quarterly, with the next event anticipated in December 2013. {{quote: "Groundwater monitoring is currently performed quarterly, with the next monitoring event scheduled for December 2013."}}
...
Nitrate as nitrogen and TDS were both reported for each of the groundwater samples, with nitrate as nitrogen concentrations ranging from 2.5 (MW-3) to 36 mg/l (MW-5) and TDS concentrations ranging from 300 (MW-3) to 750 mg/l (MW-5). {{quote: "The reported nitrate concentrations for samples from MW-1, MW-4, MW-5, MW-6, and MW-10 equal or exceed the primary MCL for nitrate of 10 mg/l, and the reported TDS concentrations for samples from MW-1, MW-4, MW-5, MW-6 and MW-10 exceed the secondary MCL for TDS of 500 mg/l."}} {{quote: "Noteworthy is that MW-1 is an upgradient monitoring well; thus, the reported nitrate and TDS concentrations of 12 and 590 mg/l, respectively, may be indicative of natural background nitrate and TDS concentrations for the shallow groundwater in the vicinity of the Site."}} Sulfide was reported for six of the ten samples with concentrations ranging from 0.011 (MW-3) to 0.28 mg/l (MW-1).
...
The laboratory prepared electronic data files for submittal to the State Water Resources Control Board GeoTracker database. The GeoTracker database is accessible via the GeoTracker website at http://geotracker.waterboards.ca.gov. The electronic data was uploaded to GeoTracker on September 23, 2013. The confirmation numbers are 3456470549 and 3162717700.
