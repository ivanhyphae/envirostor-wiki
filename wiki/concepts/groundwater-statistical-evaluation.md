...
## Site record
The statistical evaluation utilized groundwater analytical data collected from monitoring wells. The evaluation focused on constituents detected above laboratory reporting limits during post-removal groundwater monitoring events. A two-sample hypothesis test (or equivalent non-parametric method) was applied to compare concentrations in individual stockpile-area monitoring wells against pooled background data. Statistical significance was assessed at a 95% confidence level. Constituents evaluated included metals such as [[barium]] and [[chromium]], as well as volatile organic compounds and semi-volatile organic compounds when detected.
