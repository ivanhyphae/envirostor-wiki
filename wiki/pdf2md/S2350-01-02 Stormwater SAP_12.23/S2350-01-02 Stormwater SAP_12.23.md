...
Attn: Richard Stewart, PG

Subject: STORM WATER SAMPLING AND ANALYSIS PLAN
...
Subsequently, Geocon collected surface water samples from five designated surface runoff locations and two background locations on an on-call basis between April 2013 and April 2019 in accordance with the SAP addendum. The sample locations were approved by the DTSC and the Central Valley Regional Water Quality Control Board (CVRWQCB). Geocon personnel did not observe runoff migration from the Caltrans ROW during their inspections.

Road construction on SR 99/132 eliminated the need for the previously designated surface runoff sampling locations. On November 2, 2022, Stantec met with the Caltrans TO Manager to identify revised sampling locations. Two new locations and one background sampling location were added to the sampling plan.
...
At least one background sample of storm water will be collected during each sampling event. BG-West is located along the east side of North Carpenter Road approximately 700 feet south of the North Carpenter Road and Kansas Avenue intersection. BG-East is located near the northeast corner of the intersection of North Emerald Avenue and Loletta Avenue.

The proposed sampling locations are depicted on Figure 2.

Samples will be collected during qualifying rain events using a pre-cleaned or disposable scoop and transferred into laboratory-provided containers. Samples to be analyzed for dissolved metals will be filtered in the field by passing the sample through a 0.45-micron filter. The samples will be capped, labeled, chilled, and transported to Asset Laboratories (Asset) utilizing standard chain-of-custody procedures. During the sampling activities, the samples will be monitored for pH, electrical conductivity, temperature, and turbidity. If runoff is observed leaving the Caltrans ROW during our storm water sampling events, additional samples may be collected at those locations.
...
- Site Location Maps and Site Plans indicating sampling locations
...
We will provide Caltrans with a draft report after each sampling event, and upon receipt and incorporation of Caltrans' comments, we will provide the finalized report.

We appreciate the opportunity to provide our services on this project. Please contact us if you have any questions concerning the contents of this SAP or if we may be of further service.
